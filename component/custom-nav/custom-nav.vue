<template>
	<view>
		<view :style="{ 'height': navheight + 'px' ,'background-color' : bgcolor}" :class="['navbar',isScroll === true ? 'nav-fixed':'nav-normal']" v-if="mode ==='normal'">
		...
		<view :style="{ 'height': navheight + 'px' ,'background-color' : bgcolor}" :class="['navbar',isScroll === true ? 'nav-fixed':'nav-normal']"  v-if="mode ==='tool'">
		    <view :style="{'height': statusBarHeight +'px'}"></view>
		    <view class="header" :style="{'height': menuHeight +'px'}">
		...
		<view :style="{ 'height': navheight + 'px' ,'background-color' : bgcolor}" :class="['navbar',isScroll === true ? 'nav-fixed':'nav-normal']"  v-if="mode ==='logo'">
		    <view :style="{'height': statusBarHeight +'px'}"></view>
		    <view class="header" :style="{'height': menuHeight +'px'}">
					<view class="header-title-left" :style="{'line-height': menuHeight + 'px'}" @click="goHome">{{title}}</view>
		...
		mounted() {
			...
			window.onscroll = function() { 
			  var scrollTop = document.documentElement.scrollTop || document.body.scrollTop;
				  console.log(scrollTop,that.navheight)
			  if(scrollTop >= that.navheight){
				  that.isScroll = true
			  }else{
				  that.isScroll = false
			  }
